...
const botonDescargar = () => {
    return (
        <div class="hidden justify-items-center grid-cols-1 pb-4" id="descargarButton">
            <div
                class="mx-auto group relative inline-block justify-center items-center overflow-hidden rounded bg-indigo-600 px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500" onclick={downloadList}>
                ...
                <label id="fileLabel2" for="file-upload2" class="text-sm font-medium transition-all group-hover:ml-4">
                    Descargar
                </label>
            </div>
        </div>
